...
function Header({ role = 'Loco Pilot', displayTitle = 'LOCO CABIN DISPLAY' }) {
  ...
  function handleDatasetTesting() {
    navigate('/dataset-testing')
  }
      ...
      <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-lg border border-signal-blue/40 bg-signal-blue/10 shadow-glow">
            <TrainFront
              className="h-6 w-6 text-signal-blue"
              strokeWidth={2}
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={() => navigate('/loco-dashboard')}
            className="flex items-center gap-2 rounded-md border border-panel-border bg-panel/60 px-3 py-2 font-mono text-[11px] uppercase tracking-wide text-ink-muted transition-all hover:border-signal-blue/40 hover:bg-signal-blue/10 hover:text-signal-blue"
          >
          ...
          <button
            type="button"
            onClick={handleDatasetTesting}
            className="flex items-center gap-2 rounded-md border border-signal-blue/40 bg-signal-blue/10 px-3 py-2 font-mono text-[11px] uppercase tracking-wide text-signal-blue transition-all hover:bg-signal-blue/20"
          >
